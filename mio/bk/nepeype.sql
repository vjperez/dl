...
11	otro nepe de lola	2020-10-30	https://www.youtube.com/watch?v=Z3cmddZh6t8	{"fbk":"lolaEnFacebook","tt":"@lola","igrm":"@insta_lola","phn":"1234"}	{11a.jpeg,11b.jpeg}	{"book reading tutos","leemos tu libros"}	{"la uni","el colegio"}	t	'book':5 'leem':8 'libr':10 'lol':4 'nep':2 'reading':6 'tut':7	'colegio':4 'el':3 'la':1 'uni':2	{"lun":"","mar":"","mier":"","jue":"no llueve hoy","vier":"","sab":"voy sabado","dom":""}
...
SELECT pg_catalog.setval('public.bregando_bregando_id_seq', 35, true);
...
SELECT pg_catalog.setval('public.dueno_dueno_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.nepe_id_seq', 34, true);

...
--
-- Name: bregando_bregando_id_seq; Type: SEQUENCE; Schema: public; Owner: donlibre_victordbu
--
...
ALTER TABLE public.bregando_bregando_id_seq OWNER TO donlibre_victordbu;

--
-- Name: bregando_bregando_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: donlibre_victordbu
--
...
--
-- Name: dueno_dueno_id_seq; Type: SEQUENCE; Schema: public; Owner: donlibre_victordbu
--
...
ALTER TABLE public.dueno_dueno_id_seq OWNER TO donlibre_victordbu;

--
-- Name: dueno_dueno_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: donlibre_victordbu
--
...
--
-- Name: bregando_bregando_id_seq; Type: SEQUENCE SET; Schema: public; Owner: donlibre_victordbu
--
...
--
-- Name: dueno_dueno_id_seq; Type: SEQUENCE SET; Schema: public; Owner: donlibre_victordbu
--

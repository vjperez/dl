    ...
    <div class="card bg-light text-dark">
      ...
      <div class="card-body text-center">
          ...
          <div class="form-group mt-5">
              ...
              pattern="^[\s\w]*[a-zA-Z]{3,5}[\s\w]*$" maxlength="64" required>
          ...
          <div class="form-group mt-5">
              ...
              placeholder="Tu facebook, twitter, web page y/o instagram" maxlength="140" required
              pattern="^[:\/.?=&!@\s\w]*[a-zA-Z]+[:\/.?=&!@\s\w]*$">
              </textarea>
              <!-- pattern no funciona en html5 pero jQuery lo lee ; (attr pattern)-->
              <small class="text-muted">Formato: Letras, numeros, espacios, y/o   / : . _ ? = & ! @</small>
          </div>

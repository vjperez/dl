function checkUsername() {                        // Declare function
  ...
  if (username.length < 5) {                      // If username < 5 characters
    ...
    elMsg.textContent = 'si ya tiene 6 o mas';  					  // Clear the message
	// podrias poner el background totalmemte negro usando otra iamagen
	// otro class aqui y poniendo un usando el background  y la imagen en el css
	}
}

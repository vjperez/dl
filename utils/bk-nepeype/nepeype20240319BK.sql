...
1024	victor	$2y$10$iU29bhi4vBGw6qYBTvuG9.txjSTuwPkrSzi9ESmQPd1Tp4C1z8MfG	t	2024-03-19	2021-10-24
\.
...
-2147483648	uno	{"lun":"5:55 pm","mar":"612pm 20240319","mie":"","jue":"","vie":"","sab":"","dom":""}	t	t	2024-03-18	2024-03-19	t
\.
...
8	-2147483648	8	2024-03-19	0
9	-2147483648	9	2024-03-19	0
\.
...
14	-2147483648	14	2024-03-19	0
15	-2147483648	21	2024-03-19	0
19	-2147483648	23	2024-03-19	0
\.
...
1	un videito mio	-2147483648	2024-03-18	2024-03-19	0
\.
...
SELECT pg_catalog.setval('public.donde_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.dueno_nepe_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.nepe_donde_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.nepe_id_seq', -2147483648, true);
...
SELECT pg_catalog.setval('public.nepe_que_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.que_id_seq', 23, true);

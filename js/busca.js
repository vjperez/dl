jQuery('form').submit(function(evento){
    ...
    var regexp = new RegExp(/[^a-z0-9\sñüàáèéìíòóùú@._+-]/gi);	//see 'negated or complemented character class'; basically what characters are not letters, numbers or these symbols
